// P15's interaction kernel for G4HadronStoppingProcess - Bertini AND FTFP, 19,770 MB and 660 s.
//
...
template G4GPU_INTERACTION(had::InteractionBucket::kAtRest, StepTap<double>);
