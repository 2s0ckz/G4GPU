// P15's interaction kernel for the Binary light-ion reaction's fusion arm, 6,126 MB and 40 s.
//
...
template G4GPU_INTERACTION(had::InteractionBucket::kLightIon, StepTap<double>);
