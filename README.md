...
runs for nucleons and pions and its ion entry is being written; the photon's, electron's and muon's
...
driver, test, the viewer and the GUI; runs 95 tests; runs example B1 against a 2M-event Geant4
...
entries V37-V45 for Phase 1, V67-V76, V91-V94, V106-V113, V148-V157 and V162-V163 for the Binary cascade,
V85-V90, V98-V105, V114-V117, V145-V147, V158-V161, V167 and V168 for FTFP, V118-V141 for Bertini and
V142-V144 and V164-V166 for the at-rest processes, and V169-V178 for the photo- and lepto-nuclear processes.
...
| `G4BinaryLightIonReaction::Interact` and `G4BinaryCascade::Propagate1H1` | what the Binary cascade still refuses: every ion above the fusion arm, and a nucleon or pion on a hydrogen target | Phase 3, in progress (P9e). The cascade itself runs for nucleons and pions on every other target - the Phase 3 table above and [`docs/PORTED.md`](docs/PORTED.md) 2.1.10 - and the cascade is refused by name at the point it would be needed |
...
tests/        95 tests; test_custom_hook is a whole project, built as a user would build one
