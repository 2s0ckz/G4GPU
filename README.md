...
anti-nucleons and ions, and Bertini for nucleons, pions, kaons and hyperons; the decay of FTFP's
strong resonances and the Binary cascade proper are being written. The [status tables](#physics)
...
driver, test, the viewer and the GUI; runs 90 tests; runs example B1 against a 2M-event Geant4
...
V98-V105 and V114-V117 for FTFP, and V118-V141 for Bertini.
...
tests/        90 tests; test_custom_hook is a whole project, built as a user would build one
