...
driver, test, the viewer and the GUI; runs 47 tests; runs example B1 against a 2M-event Geant4
...
tests/        47 tests; test_custom_hook is a whole project, built as a user would build one
