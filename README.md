...
or negative hyperon is captured as Geant4 captures it; the decay of FTFP's strong resonances, the
at-rest capture of anti-baryons and the Binary cascade proper are being written. The
[status tables](#physics) below say exactly what is there and what is not.
...
driver, test, the viewer and the GUI; runs 92 tests; runs example B1 against a 2M-event Geant4
...
V142-V144 and V164-V166 for the at-rest processes.
...
tests/        92 tests; test_custom_hook is a whole project, built as a user would build one
