...
set TESTS_GPU=test_step_hook test_neutron test_step_hadron test_capture_device test_ion_transport test_neutron_general test_lepton_transport test_inelastic_transport
